...
public class ShipFactory {
    ...
    public static Ship MarkIShip(int startPosition, int numberOfShips, Color color) throws Exception {
        ...
        return new Ship(200,400,0.3,"S-class", "Mark I", shapeX, shapeY, flameX, flameY, gunPositionX, gunPositionY, startPosition, numberOfShips, color);
    }

    public static Ship MarkIIShip(int startPosition, int numberOfShips, Color color) throws Exception {
        initializeRanks();
        ...
        return new Ship(200,400,0.3,"S-class", "Mark II", shapeX, shapeY, flameX, flameY, gunPositionX, gunPositionY, startPosition, numberOfShips, color);
    }

    public static Ship AlexI(int startPosition, int numberOfShips, Color color) throws Exception {
        initializeRanks();
