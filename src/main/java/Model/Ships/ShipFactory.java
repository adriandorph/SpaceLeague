...
public class ShipFactory {
    ...
    public static Ship BoxShip(StartPosition startPosition, boolean flyable){
        ...
        if (flyable) return new FlyableShip(100,100,1,"S-class", "The Box", shapeX, shapeY, gunPositionX, gunPositionY, startPosition);
        else return new Ship(100,100,1,"S-class", "The Box", shapeX, shapeY, gunPositionX, gunPositionY, startPosition);
    }
